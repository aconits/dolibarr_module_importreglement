...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.importpayment.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[TImportPayment.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[TImportPayment.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[TImportPayment.STATUS_REFUSED]]
